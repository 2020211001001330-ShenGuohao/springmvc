...
public class UserController {
    ...
    public void getUserName3(@RequestParam(value="name",required=false,defaultValue="com.com.com.icu")
    										String username) {
        System.out.println("username=" + username );
    }
	 ...
	 *	请求路径：http://localhost:8080/chapter12-02/user/1003/tom/123456
	 *	 如2：
	 *	@RequestMapping("/user/{name}")
	 *	请求路径：http://localhost:8080/chapter12-02/user/tom
     */
    @RequestMapping("/user/{name}")
